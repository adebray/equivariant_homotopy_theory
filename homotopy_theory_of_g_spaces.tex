...
terms of the actual cells we use. It's also worth mentioning that the action of $G$ on our actual $G$-cells is
cellular, unlike for the other cells.\footnote{{\color{red}TODO}: there must have been a different word than
``cellular'' here; what was it?}
\begin{ex}
