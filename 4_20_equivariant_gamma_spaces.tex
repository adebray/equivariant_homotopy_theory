...
\begin{itemize}
	\item \term[Gamma-G-space@$\Gamma$-$G$-spaces]{$\Gamma$-$G$-spaces} are $\Gamma$-objects in $G\Top_*$. These
	...
	$G$ acts by conjugation on the mapping space. Then, \term[GammaG-space@$\Gamma_G$-space]{$\Gamma_G$-spaces} are
...
\begin{comp}{rem}{enumerate}
	...
	very special objects into connective genuine $G$-spectra.\index{very special $\Gamma$-$G$-space}
