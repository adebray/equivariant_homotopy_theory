...
We'll begin talking about the orbit category in the rest of today's lecture, then discuss the bar construction in
the context of Elmendorf's theorem (\cref{revElmen}).
\begin{defn}
