...
basepoint. $\fD$-spaces are called \term[Gamma-spaces@$\Gamma$-spaces]{$\Gamma$-spaces}, and agree with Segal's
...
\begin{defn}
Similarly, we define an \term[for orthogonal spectra]{$\Omega$-spectrum} in orthogonal spectra to be an orthogonal
spectrum $X$ such that the adjoints to the structure maps $X(U)\congto\Omega^V X(U\oplus V)$ are homeomorphisms.
\end{defn}
