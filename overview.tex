...
\begin{itemize}
	...
	with $G$-action $(gf)(g') = f(g'g)$. This is called the \term{coinduced $G$-action} on $H$.\footnote{This actually \textit{is} a group action since (a(b(f)))(g) = (b(f))(ga) = f(gab) = (ab(f))(g).}\qedhere
\end{itemize}
\end{exm}
\begin{exm}
