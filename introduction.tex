...
Hoek, Hana Jia Kong, Charles Rezk, Sean Tilson, Yixian Wu, and Github user \texttt{tbrazel} for catching a few
errors; to Andrew Blumberg, Ernie Fontes, Tom Gannon, Tyler Lawson, Richard Wong, Valentin Zakharevich, an
anonymous reader, and the users of the homotopy theory Mathoverflow chatroom for some clarifications and
suggestions; to Adrian Clough, Richard Wong, and Yuri Sulyma for adding some examples, remarks, and references; and
to Richard Wong for the cover page.
