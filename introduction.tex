...
\begin{itemize}
	\item The first is trace methods in algebraic $K$-theory:\index{trace methods in algebraic $K$-theory}
	Hochschild homology\index{Hochschild homology} and its topological cousins are equipped with natural
...
increasing sense that a lot of the foundations here are best done in $\infty$-categories.\index{$\infty$-category}
...
\begin{itemize}
	...
	\item $X$ is \term[compactly generated topological space]{compactly generated} if every compactly closed
