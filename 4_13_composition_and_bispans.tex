...
\begin{enumerate}
	...
	the norm is the \term{Evens multiplicative transfer}, which we'll talk about next time.
...
is a functor $P_\fD^G\to\Ab$. In~\cite{BlumbergHill}, these are called \term{incomplete Tambara functors}.
\end{defn}
