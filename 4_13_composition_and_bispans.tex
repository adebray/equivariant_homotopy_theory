...
\term[wide subcategory]{wide} (i.e.\ contains all objects in $\fC$), closed under pullbacks, and closed under
...
consider this notion of multiplication.\index{Ninfinity-operad@$N_\infty$-operad}
...
useful? Maybe.\index{Dwyer-Kan hammock localization}
\end{rem}
