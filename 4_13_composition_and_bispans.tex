...
functor} is a functor $P_\fD^G\to\Ab$. In~\cite{BlumbergHill}, these are called \term[incomplete Tambara
functor]{incomplete Tambara functors}.\index{D-Tambara functor@$\fD$-Tambara functor|see {incomplete Tambara
functor}}
\end{defn}
