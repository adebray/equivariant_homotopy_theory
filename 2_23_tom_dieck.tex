...
technology: suppose $X$ and $Y$ are $G$-spaces and $H\subseteq G$ is normal. Then, there is a \term[restriction
map!for fixed points of a $G$-space]{restriction map}
...
natural.}\index{topological cyclic homology}
\begin{lem}
\label{restrlem}
