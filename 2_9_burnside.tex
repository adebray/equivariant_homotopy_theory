...
\begin{itemize}
	...
	$G$-action!on an $H$-module]{induced $G$-module} $\Ind_H^G N$.
	\item The right adjoint sends $N\mapsto\Map_H(\Z[G], N)$. This is called the \term[coinduced $G$-action!on an
	$H$-module]{coinduced $G$-module}, written $\CoInd_H^GN$.
\end{itemize}
