...
Today, we're going to talk about the Burnside category. There are at least five ways of defining it: we'll start
with \cref{burn1} and later provide an alternative, \cref{burn2}. Today we'll also talk about spectra; some things
will be precise, and others will be made precise next time.
