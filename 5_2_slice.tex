Today, we're going to discuss the slice spectral sequence, the equivariant version of the Postnikov spectral
...
The general formulation of the slice spectral sequence was worked out in~\cite{HHR}; see also~\citeme{Hu-Kriz}. The
exposition in~\cite{HHR} is pretty good, and you should also check out Mike Hill's introduction~\cite{HillSlice}.
\citeme{Hill, Hopkins, Ravenel} also have papers working out some computations with the slice
spectral sequence.
