...
as relating to $K$-theory of $BG$ (e.g.\ the representation ring $\mathrm{RO}(G)$ is $KO^0(BG)$). More generally, do $KO(BG)$ or $MO(BG)$ play a special role ``controlling'' the $G$-equivariant stable category? % Strickland K(n)-local duality for finite groups and groupoids
\end{ques}
