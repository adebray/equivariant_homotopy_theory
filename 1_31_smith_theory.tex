...
$X$ is an $\F_p$-cohomology sphere.\footnote{A space $X$ is an \term[Fp-cohomology sphere@$\F_p$-cohomology
...
pullback). This is a ``fattened up'' version of $X/G$.\index{balanced product}
\begin{defn}
