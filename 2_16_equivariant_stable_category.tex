...
\begin{comp}{defn}{itemize}
	...
	\item A $G$-prespectrum is an \term[Omega-prespectrum@$\Omega$-prespectrum!for
	$G$-spectra]{$\Omega$-prespectrum} if for all $V$ and $W$, the adjoint to the structure map is a homeomorphism:
	$X(V)\congto\Omega^W X(V\oplus W)$.
...
Let $X$ be a based $G$-space; then, the \term[of a $G$-space]{suspension spectrum} of $X$, denoted $\Sigma^\infty
...
splitting]{tom Dieck splitting} as a wedge of other pieces.
\end{warn}
\begin{defn}
