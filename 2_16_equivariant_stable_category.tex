...
cell, which admits a direct proof. Once again the stable homotopy category behaves like homological algebra.
\begin{exm}
...
Let $X$ be a based $G$-space; then, the \term{suspension spectrum} of $X$, denoted $\Sigma^\infty X$, is the
$G$-spectrum whose component on a $G$-representation $V$ is
