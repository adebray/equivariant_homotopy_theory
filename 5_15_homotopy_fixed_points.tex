...
points!for $G$-spectra}is the nonequivariant spectrum $X^{hG}\coloneqq F((EG)_+, X)^G$, i.e.\ the spectrum
...
(nonequivariant) $K$-theory:\index{real $K$-theory}\index{KR-theory@$\KR$-theory|see {real $K$-theory}}
\begin{thm}
$\KR^{hC_2} = \KO$.
\end{thm}
...
connective real $K$-theory $\mathit{kr}$.\index{connective real $K$-theory}
