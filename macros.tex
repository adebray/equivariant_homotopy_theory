...
%	  (source: https://tex.stackexchange.com/a/6089)
%	- Use \synonym{a}{b} to print b, but index as "see a"
% some of these commands could be improved though. Namely, \term[$...] fails silently
\usepackage{suffix}
\NewDocumentCommand{\term}{o m}{{\bfseries #2}\index{\IfValueTF{#1}{#1}{#2}|textit}}
