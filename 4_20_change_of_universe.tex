...
In the equivariant setting, we can think of \term{$G$-$\Gamma$-spaces}, $\Gamma$-objects in $G\Top_*$, which is
sensible, or we can think of \term{$\Gamma_G$-spaces} through $\Gamma_G$, the category of finite based $G$-sets and
