...
of $\Omega$-spectra?\index{orthogonal $G$-spectra}\index{diagram spectra}\index{Omega-spectra@$\Omega$-spectra}
\end{ques}
...
orthogonal spectra?\index{orthogonal spectra}
\end{ques}
...
though.\index{Gamma-spaces@$\Gamma$-spaces}
\begin{ques}
...
picture that explains what's going on.\index{$\infty$-operad}
% \begin{ques}
