...
is a theory of cellular objects. If $F_d\colon\Top_*\to\Fun(\fD,\Top_*)$ is the left adjoint to $\Ev_d$ we constructed
...
(Definition~\ref{stable_equivalenc}). It follows immediately that $\Omega$-prespectra are local objects and stable
