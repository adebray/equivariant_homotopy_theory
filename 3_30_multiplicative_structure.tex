...
pullback $f^*\colon\Top[O']\to\Top[O]$ and a \term{change of scalars} operad $B(O',O,\bl)\colon\Top[O]\to\Top[O']$;
...
specifically the \term{Evans norm}. And figuring out how to make this work was one of the important new ideas
in~\cite{HHR}.
