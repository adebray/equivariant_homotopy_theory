...
\begin{itemize}
	...
	maps $G\to X$, with $G$-action $(gf)(g') = f(g'g)$. This is called the \term[coinduced $G$-action!on an
	$H$-space]{coinduced $G$-action} on $\Map^H(G,X)$.\footnote{This actually \emph{is} a group action, since if
